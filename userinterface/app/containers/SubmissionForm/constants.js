...
export const SAVE_FORM_SUCCESS = 'app/SubmissionForm/SAVE_FORM_SUCCESS';
export const SAVE_FORM_ERROR = 'app/SubmissionForm/SAVE_FORM_ERROR';

export const SUBMIT_FORM = 'app/SubmissionForm/SUBMIT_FORM';
export const SUBMIT_FORM_START = 'app/SubmissionForm/SUBMIT_FORM_START';
