...
app.autodiscover_tasks(
    [
        ...
        "gfbio_submissions.brokerage.tasks.jira_tasks.attach_cloud_upload_to_submission_issue_task",
        ...
        "gfbio_submissions.brokerage.tasks.process_tasks.validate_against_ena",
        "gfbio_submissions.brokerage.tasks.process_tasks.process_targeted_sequence_results",
        "gfbio_submissions.brokerage.tasks.process_tasks.trigger_submission_process",
        "gfbio_submissions.brokerage.tasks.process_tasks.transfer_data_to_ena",
        "gfbio_submissions.brokerage.tasks.process_tasks.register_study_at_ena",
        "gfbio_submissions.brokerage.tasks.process_tasks.process_ena_response",
        "gfbio_submissions.brokerage.tasks.process_tasks.submit_to_ena_test_server",
        "gfbio_submissions.brokerage.tasks.process_tasks.update_ena_embargo",
        "gfbio_submissions.brokerage.tasks.process_tasks.trigger_submission_process_for_updates",
        "gfbio_submissions.brokerage.tasks.process_tasks.submit_targeted_sequence_to_ena",
