...
class Command(BaseCommand):
    help = 'Read part of sql dump with legacy brokerage.RequestLog data ' \
                ...
                for f in file.readlines():
                    ...
                    if len(row) == 12:
                        ...
                        try:
                            ...
                            print('Found RequestLog for request_id:',
                                  request_id, ' object.created data: ',
                                  r.created, ' | change to: ', created, ' ...')
                            r.created = created
                            r.save()
                            print('\t... done.')
