...
class TestSubmissionUploadView(TestCase):
    ...
    def test_get_list_per_submission(self):
        ...
        data_2 = self._create_test_data("/tmp/test_primary_data_file_2", delete=False)
    ...
    def test_list_uploads_queryset(self):
        ...
        url_2 = reverse(
            "brokerage:submissions_upload",
            kwargs={"broker_submission_id": submission_2.broker_submission_id},
        )
        ...
        content = json.loads(response.content.decode("utf-8"))
        self.assertEqual(1, len(content))
        self.assertTrue(content[0].get("file", "").endswith("test_primary_data_file_2"))
    ...
    def test_get_detail(self):
        ...
        url = reverse(
            ...
            kwargs={"broker_submission_id": submission.broker_submission_id, "pk": 1},
        )
    ...
    def test_wrong_submission_put(self):
        ...
        submission.additionalreference_set.create(type=GFBIO_HELPDESK_TICKET, reference_key="FAKE_KEY_2", primary=True)
        url = reverse(
            "brokerage:submissions_upload_detail",
            kwargs={
                "broker_submission_id": submission.broker_submission_id,
        ...
        data = self._create_test_data("/tmp/test_primary_data_file_2222", delete=False)
    ...
    def test_file_put_modified_content_with_task(self):
        ...
        data = self._create_test_data(
            "/tmp/test_primary_data_file_1111",
            delete=False,
            attach=True,
            content="different\n",
        )
