...
class TestSubmissionUploadViewForAtaxTarget(TestCase):
    ...
    #
    #     if delete:
    #         TestSubmissionUploadView._delete_test_data()
    ...
    #     )
    #
    #     data = TestSubmissionUploadView._create_test_data("/tmp/{0}".format(file_name), attach=attach)
    #
    ...
    def test_upload_to_atx_submission_with_changed_status(self):
        ...
        # for a in SubmissionUpload.objects.all():
        #     print(a, a.submission)
        self.assertEqual(1, len(submission.submissionupload_set.all()))
