...
from rest_framework import generics, mixins, parsers, permissions, status
...
from ..configuration.settings import SUBMISSION_DELAY, SUBMISSION_ISSUE_CHECK_DELAY, SUBMISSION_UPLOAD_RETRY_DELAY
from ..forms import SubmissionCommentForm
from ..models import Submission, SubmissionUpload
from ..permissions import IsOwnerOrReadOnly
from ..serializers import SubmissionDetailSerializer, SubmissionUploadListSerializer, SubmissionUploadSerializer
...
class SubmissionsView(mixins.ListModelMixin, mixins.CreateModelMixin, generics.GenericAPIView):
    ...
    def perform_create(self, serializer):
        ...
        chain = (
            ...
            | trigger_submission_transfer.s(submission_id=submission.pk).set(countdown=SUBMISSION_DELAY)
        )
...
class SubmissionUploadDetailView(
    ...
    def delete(self, request, *args, **kwargs):
        obj = self.get_object()
        from gfbio_submissions.brokerage.tasks import delete_submission_issue_attachment_task
