...
def gfbio_prepare_create_helpdesk_payload(site_config, submission, reporter={}, prepare_for_update=False):
    ...
    mutual_data = {
        ...
        "customfield_13100": f"{settings.HOST_URL_ROOT}api/downloads/submissions/{submission.broker_submission_id}/uploads/zip/",
        "customfield_13101": f"{settings.HOST_URL_ROOT}edit/{submission.broker_submission_id}/",
    }
