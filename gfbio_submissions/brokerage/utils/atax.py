...
from ..utils.csv_atax import (
    ...
    add_necc_nodes_multimedia,
    add_multimediaobjects,
...
abcd_mapping_multimedia_pathes = {
    ...
    "File description": "MultiMediaObject/Context",
    # Holotype of Platypelis lateus (FGZC 3761) in life   /IPRStatements' Comment wäre auch mgl., nee für was anderes
    ...
    "License Type": "MultiMediObject/IPR//Licenses/License/Text",
    # CC BY-NC-SA 4.0   for statement, additionally add here 'URI'' like https://creativecommons.org/licenses/by-sa...
...
class Ataxer(object):
    ...
    def create_atax_submission_base_xml(self):
        ...
        add_meta_data(
            dataset,
            self.abcdns,
            self.atax_submission.user,
            self.atax_submission.created,
        )
