...
def update_ena_submission_data_task(self, previous_task_result=None, submission_id=None):
    ...
    logger.info(
        ...
        "".format(submission.broker_submission_id)
    )
        ...
        for d in ena_submission_data:
            ...
            try:
                (
                    obj,
                    created,
                ) = submission.auditabletextdata_set.update_or_create(
