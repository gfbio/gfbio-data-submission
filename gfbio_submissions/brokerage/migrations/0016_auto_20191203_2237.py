...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='file',
            field=models.FileField(help_text='The actual file uploaded.', storage=gfbio_submissions.brokerage.storage.OverwriteStorage(), upload_to=gfbio_submissions.brokerage.utils.submission_tools.submission_upload_path),
        ),
    ]
