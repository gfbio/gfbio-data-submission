        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "external_id",
                    models.CharField(
                        help_text="Not Required. 32 characters or fewer. Has to be unique if not Null.", max_length=32
                    ),
                ),
                ...
                (
                    "resolver_url",
                    models.URLField(
                        blank=True, help_text='An URL to resolve the value of "external_id"', max_length=64, null=True
                    ),
                ),
