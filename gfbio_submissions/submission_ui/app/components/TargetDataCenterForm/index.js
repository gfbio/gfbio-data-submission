    ...
    return (
      <div>
        ...
        <div className="form-group">
          <select className="form-control" id="targetDataCenter">
            <option />
            ...
            <option>
              BGBM – Botanic Garden and Botanical Museum Berlin, Freie
              Universität Berlin
            </option>
            <option>
              DSMZ – Leibniz Institute DSMZ – German Collection of
              Microorganisms and Cell Cultures, Braunschweig
            </option>
            <option>
              MfN – Leibniz Institute for Research on Evolution and
              Biodiversity, Berlin
            </option>
            <option>
              SGN – Senckenberg Gesellschaft für Naturforschung – Leibniz
              Institute, Frankfurt
            </option>
            <option>SMNS – State Museum of Natural History Stuttgart</option>
            <option>
              SNSB – Staatliche Naturwissenschaftliche Sammlungen Bayerns – SNSB
              IT Center, München
            </option>
            <option>
              ZFMK – Zoological Research Museum Alexander Koenig – Leibniz
              Institute for Animal Biodiversity, Bonn
            </option>
          </select>
        </div>
      </div>
